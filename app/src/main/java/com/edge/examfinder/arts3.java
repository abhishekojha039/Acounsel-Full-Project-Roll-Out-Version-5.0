...
public class arts3 extends AppCompatActivity implements math3Adapter.OnIteamClickListner{
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            mmathAdapter=new math3Adapter(arts3.this,mmathRecyclerViews);
                            mRecycler.setAdapter(mmathAdapter);
                            mmathAdapter.setOnIteamClickListner(arts3.this);
