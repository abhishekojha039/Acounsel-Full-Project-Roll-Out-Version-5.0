...
public class commerce2 extends AppCompatActivity implements math2Adapter.OnIteamClickListner{
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            mmathAdapter=new math2Adapter(commerce2.this,mmathRecyclerViews);
                            mRecycler.setAdapter(mmathAdapter);
                            mmathAdapter.setOnIteamClickListner(commerce2.this);
