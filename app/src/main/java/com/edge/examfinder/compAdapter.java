...
public class compAdapter extends RecyclerView.Adapter<compAdapter.ExampleViewHolder>{

    private Context mContext;
    RequestOptions options;
    private ArrayList<compRecycler> mlist;
    ...
    public compAdapter(Context context,ArrayList<compRecycler> list)
    {
        mContext=context;
        mlist=list;
    ...
    public void onBindViewHolder(@NonNull ExampleViewHolder holder, int position) {
        compRecycler currentItem=mlist.get(position);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(mListner!=null)
                    {
                        ...
                        {
                            mListner.onIteamClick(position);
                        }
                    }
                }
            });
