...
public class finalAdapter extends RecyclerView.Adapter<finalAdapter.ExampleViewHolder>{

    private Context mContext;
    RequestOptions options;
    private ArrayList<finalRecycler> mlist;
    ...
    public finalAdapter(Context context,ArrayList<finalRecycler> list)
    {
        mContext=context;
        mlist=list;
    ...
    public void onBindViewHolder(@NonNull ExampleViewHolder holder, int position) {
        finalRecycler currentItem=mlist.get(position);
