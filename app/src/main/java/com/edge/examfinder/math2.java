...
public class math2 extends AppCompatActivity implements math2Adapter.OnIteamClickListner{
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            mmathAdapter=new math2Adapter(math2.this,mmathRecyclerViews);
                            mRecycler.setAdapter(mmathAdapter);
                            mmathAdapter.setOnIteamClickListner(math2.this);
    ...
    public void onItemClick(int position) {
        Intent intent=new Intent(this,math3.class);
