...
public class math2Adapter extends RecyclerView.Adapter<math2Adapter.ExampleViewHolder>{
    ...
    public math2Adapter(Context context,ArrayList<mathRecyclerView> list)
    {
        mContext=context;
        mlist=list;
